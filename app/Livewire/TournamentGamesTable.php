...
class TournamentGamesTable extends BaseWidget
{
    ...
    public function table(Table $table): Table
    {
        ...
        try {
            $response = $gameApi->getCustomerGamesPlayed(
                $this->customerId,
                tournamentPage: $this->page,
                perPage: $this->perPage
            );
        } catch (\Throwable $e) {
            $response = ['tournament_games' => ['data' => []]];
        }

        $gamesData = $response['tournament_games'] ?? [];
    ...
    {
        return view('livewire.tournament-games-table', $this->getViewData());
    }
}
